...
\begin{figure}[h!]
    \centering
    \includegraphics[width=1\textwidth]{combined_execution_time_comparison.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=1\textwidth]{combined_distance_to_optimum_comparison.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=1\textwidth]{combined_iterations_comparison.png}
